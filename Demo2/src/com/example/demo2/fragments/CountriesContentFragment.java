...
import com.example.demo2.activity.MainActivity;
...
public class CountriesContentFragment extends Fragment implements TabListener{
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		actionbar.addTab(actionbar.newTab().setText(getString(R.string.tittle_fragment_list)).setTabListener(this));
		actionbar.addTab(actionbar.newTab().setText(getString(R.string.tittle_fragment_flags)).setTabListener(this));

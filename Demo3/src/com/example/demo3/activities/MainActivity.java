...
import com.example.demo3.data.Helper;
import com.example.demo3.data.Image;
import com.example.demo3.data.ImageAdapter;
import com.example.demo3.fragment.PhotoDialogFragment;
import com.example.demo3.fragment.PhotoDialogFragment.NoticeDialogListener;
...
public class MainActivity extends FragmentActivity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Parse.initialize(this, "6ZrHElKPUffWeyDS4aPipWeGY1p7ZtBXrobq5Pf3", "eRTJ2l8KEaQBs87UPUS0GzH818lG26AabKgAmuXM");
	...
	private void parse() {
		...
		test.put("nombre", "Chrisb");
		test.saveInBackground();
		Log.e("TAG", "Guardando...");
		//Modificar nombre del identificador
		ParseQuery<ParseObject> query = ParseQuery.getQuery("Prueba");
		query.getInBackground("sg58rueEUU", new GetCallback<ParseObject>() {
